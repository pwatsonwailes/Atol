<?php
namespace DAMC\modules\_global\adapters\phpmailer;
/*~ class.phpmailer.php
.---------------------------------------------------------------------------.
...
class PHPMailer {
   ...
   * projects that do not have HTML email capability such as mutt. Projects
 ...
 */
  ...
  public function SmtpConnect() {
    if(is_null($this->smtp)) {
      $this->smtp = new \DAMC\modules\_global\adapters\smtp\SMTP;
    }
